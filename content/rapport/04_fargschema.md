...
<!-- Sidan använder sig av mycket vit som bakgrundsfärg, i ett syfte som jag skulle anta är till för
att behålla fokus till innehållet som presenteras. Det gör det även lättare att ha bilder (som
sidan använder sig av) då det är mindre risk att den mixar med bakgrundsfärgen.
Allt I allt tycker jag att användningen av gul samt liten del svart är relevant till deras logo
med samma färger. Användningen av dessa färger känns ganska svagt i syfte att föra fram loggan,
men sidan är väldigt användarvänlig utan onödiga detaljer. -->
...
Lantmännen skulle jag anse använder sig av den gröna färgen som kan länka till tanken
